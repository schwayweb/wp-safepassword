...
class spcmsProtect {
    ...
    function show($string){
        ...
        $string = $this->decode($spcms['key_one'], $string);
        $string = $this->decode($spcms['key_two'], $string);
        $string = $this->decode($spcms['key_three'], $string);
        $string = $this->decode($spcms['key_four'], $string);
    ...
    function hide($string){
        ...
        $string = $this->encode($spcms['key_one'], $string);
        $string = $this->encode($spcms['key_two'], $string);
        $string = $this->encode($spcms['key_three'], $string);
        $string = $this->encode($spcms['key_four'], $string);
    ...
    function ip(){
        ...
        if ($this->server('HTTP_CLIENT_IP', 'ip') != '') {
            $ip = $this->server('HTTP_CLIENT_IP', 'ip');
        } elseif ($this->server('HTTP_X_FORWARDED_FOR', 'ip') != '') {
            $ip = $this->server('HTTP_X_FORWARDED_FOR', 'ip');
        } else {
            $ip = $this->server('REMOTE_ADDR', 'ip');
        }
