...
(function($){
  ...
  var spsafepwdGeneral = {
      currencies: {
          ...
          get: function(){
              ...
              for(var key in spsafepwdGeneral.currencies.data){

                  myCurrencies[i] = {};
                  myCurrencies[i]['name'] = spsafepwdGeneral.currencies.data[key]['name']+' ( '+spsafepwdGeneral.currencies.data[key]['symbol']+' )';
                  myCurrencies[i]['value'] = spsafepwdGeneral.currencies.data[key]['code'];
                  i++;
              }
          ...
          sign: function(code) {
              ...
              for(var key in spsafepwdGeneral.currencies.data){
                  ...
                  if(code === spsafepwdGeneral.currencies.data[key]['code']) {
                      return spsafepwdGeneral.currencies.data[key]['symbol'];
                  }
              }
      ...
      languages: {
          ...
          get: {
              all: function(){
                  ...
                  for(var key in spsafepwdGeneral.languages.data){
                      myLanguages[i] = {};
                      myLanguages[i]['name'] = spsafepwdGeneral.languages.data[key]['name'];
                      myLanguages[i]['value'] = spsafepwdGeneral.languages.data[key]['code'];
                      i++;
                  }
              ...
              name: function(code){
                  ...
                  for(var key in spsafepwdGeneral.languages.data){
                      ...
                      if(spsafepwdGeneral.languages.data[key]['code'] === code) {
                          myLanguage = spsafepwdGeneral.languages.data[key]['name'];
                      }
                  }
      ...
      select: {
        ...
        optionsTime: function(){
            ...
            newOptions[0]['name']   = sptext['cancellation_no'];
          ...
          //Days
            for(var i = 1; i < 7; i++) {
                ...
                if(i === 1) {
                    newOptions[i]['name']   = sptext['cancellation_before_day'];
                } else {
                    newOptions[i]['name']   = sptext['cancellation_before_days'].split('%s').join(i);
                }
           ...
           // Weeks
            for(var i = 7; i < 22; i++) {
                ...
                if(i === 7) {
                    newOptions[i]['name']   = sptext['cancellation_before_week'];
                } else {
                    newOptions[i]['name']   = sptext['cancellation_before_weeks'].split('%s').join(i/7);
                }
                newOptions[i]['value']  = i;
               i = i+6;
            }
           ...
           // Months
            for(var i = 28; i < 169; i++) {
                ...
                if(i === 28) {
                    newOptions[i]['name']   = sptext['cancellation_before_month'];
                } else {
                    newOptions[i]['name']   = sptext['cancellation_before_months'].split('%s').join(i/28);
                }
                newOptions[i]['value']  = i;
               i = i+27;
            }
      ...
      getTime: function(selectedTime){
        var time_name = sptext['cancellation_no'];
        ...
        if(selectedTime > 1) {
            ...
            if(selectedTime < 2){
                time_name = sptext['cancellation_before_day'];
            } else if(selectedTime < 7){
                time_name = sptext['cancellation_before_days'].split('%s').join(selectedTime);
            } else if(selectedTime === 7){
                time_name = sptext['cancellation_before_week'];
            } else if(selectedTime < 22){
                time_name = sptext['cancellation_before_weeks'].split('%s').join(i/7);
            } else if(selectedTime === 28){
                time_name = sptext['cancellation_before_month'];
            } else if(selectedTime < 169){
                time_name = sptext['cancellation_before_months'].split('%s').join(i/28);
            }
        }
  ...
  window.spsafepwdGeneral = spsafepwdGeneral;
  ...
  var spsafepwdTabs = {
      start: function(box, data){
          ...
          HTML.push('<div class="safepwd-tabs">');
          HTML.push('   <div class="safepwd-tabs-menu">');
          
          for(var key in data){
              HTML.push('   <div id="safepwd-tab-'+data[key]['name']+'" class="safepwd-tab-menu'+(first === true ? ' safepwd-opened':'')+'">'+data[key]['label']+'</div>');
              first = false;
          }
        
          HTML.push('   </div>');
          HTML.push('   <div class="safepwd-tabs-content">');
        
          for(var key in data){
              HTML.push('   <div id="safepwd-tab-'+data[key]['name']+'-content" class="safepwd-tab-content'+(firstTab === false ? ' safepwd-invisible':'')+'"></div>');
              firstTab = false;
          }
          ...
          spsafepwdTabs.events();
      },
      box: function(name){
          return $('#safepwd-tab-'+name+'-content');
      },
      add: function (name, content, callbackfn){
          spsafepwdTabs.box(name).html(content);
      ...
      events: function(){
          ...
          $('.safepwd-tab-menu').unbind('click');
          $('.safepwd-tab-menu').bind('click', function(){
              $('.safepwd-tab-menu').removeClass('safepwd-opened');
              $(this).addClass('safepwd-opened');
              $('.safepwd-tab-content').addClass('safepwd-invisible');
              $('#'+$(this).attr('id')+'-content').removeClass('safepwd-invisible');
          });
      }
  };
  
  window.spsafepwdTabs = spsafepwdTabs;
  
  var spsafepwdAccordion = {
      start: function(box, data, css_class){
          ...
          for(var key in data){
              HTML.push('<div class="safepwd-accordion'+(css_class !== undefined ? ' '+css_class:'')+(data[key]['class'] !== undefined ? ' '+data[key]['class']:'')+'" id="safepwd-accordion-'+data[key]['name']+'" class="safepwd-accordion-menu'+(first === true ? ' safepwd-opened':'')+'">');
              HTML.push('   <div class="safepwd-accordion-arrow" data-id="safepwd-accordion-'+data[key]['name']+'"></div>');
              HTML.push('   <div class="safepwd-accordion-element" data-id="safepwd-accordion-'+data[key]['name']+'">');
              HTML.push('       <h3 data-id="safepwd-accordion-'+data[key]['name']+'">');
              HTML.push(          data[key]['label']);
              HTML.push('       </h3>');
              HTML.push('   </div>');
              HTML.push('   <div class="safepwd-accordion-content" id="safepwd-accordion-'+data[key]['name']+'-content">');
              HTML.push('       <div class="safepwd-accordion-content-box">'+(data[key]['content'] !== undefined ? ' '+data[key]['content']:'')+'</div>');
              HTML.push('   </div>');
              HTML.push('</div>');
              first = false;
          }
          ...
          spsafepwdAccordion.events();
      },
      box: function(name){
          return $('#safepwd-accordion-'+name+'-content .safepwd-accordion-content-box');
      },
      add: function (name, content, callbackfn){
          spsafepwdAccordion.box(name).html(content);
      ...
      events: function(){
          ...
          $('.safepwd-accordion-arrow, .safepwd-accordion-element').unbind('click');
          $('.safepwd-accordion-arrow, .safepwd-accordion-element').bind('click', function(){
              var currentID = $(this).attr('data-id');
            
              if($('#'+currentID).hasClass('safepwd-opened')) {
                  $('#'+currentID).removeClass('safepwd-opened');
              } else {
                  $('#'+currentID).addClass('safepwd-opened');
              }
          });
      }
  };
  
  window.spsafepwdAccordion = spsafepwdAccordion;
  
  $('.safepwd-menu').after().click(function() {
      $('.safepwd-popup').toggleClass('safepwd-open');
      $(this).toggleClass('safepwd-menu-active');
  });
})(jQuery);
